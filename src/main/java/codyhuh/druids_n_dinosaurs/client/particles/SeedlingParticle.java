...
@OnlyIn(Dist.CLIENT)
public class SeedlingParticle  extends TextureSheetParticle {
    private final double xStart;
    private final double yStart;
    private final double zStart;

    SeedlingParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
        ...
        this.y = this.yo;
        this.z = this.zo;
        this.quadSize = 0.5F * (this.random.nextFloat() * 0.5F + 0.2F);
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            SeedlingParticle enchantmenttableparticle = new SeedlingParticle(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed);
