...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case ALOEWOOD -> ModItems.ALOEWOOD_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.ALOEWOOD.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        ALOEWOOD(ModBlocks.ALOEWOOD_PLANKS.get(), "aloewood");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, ALOEWOOD);
        }
    }
}
